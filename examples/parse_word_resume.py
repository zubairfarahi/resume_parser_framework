"""Example: Parse Word resume using field-specific extractors.
...
def main() -> None:
    ...
    # Define the path to the Word resume
    resume_path = "path/to/resume.docx"  # Update with actual path

    print("=" * 60)
    print("Resume Parser Framework - Word Document Example")
    print("=" * 60)
